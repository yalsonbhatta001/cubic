	...
	<div class="container">
		...
		<div class="panel panel-primary">
		  ...
		  <form action="register" method="post">
			<div class="row">
				<div class="col-md-3">EmpName</div><div class="col-md-9"><input type="text" name="employee_name"/></div>
			</div>
			<div class="row">
				<div class="col-md-3">EmailId</div><div class="col-md-9"><input type="text" name="email_id"/></div>
			</div>
			<div class="row">
